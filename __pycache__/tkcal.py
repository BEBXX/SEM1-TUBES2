...
btnAdd = tk.Button(root, text="TAMBAH",font="Corbel 9 bold", fg = "White", bg = "#474954", width=25,height=2, command=AddForm)
btnAdd.grid(row=13, column=0, sticky='WS')

btnDel = tk.Button(root, text="HAPUS",font="Corbel 9 bold", fg = "White", bg = "#474954", width=25,height=2, command=delTodo)
btnDel.grid(row=14, column=0, sticky='WS')

btnLoad = tk.Button(root, text="LOAD",font="Corbel 9 bold", fg = "White", bg = "#474954", width=25,height=2, command=LoadTodos)
btnLoad.grid(row=13, column=0, sticky='ES')

btnSave = tk.Button(root, text="SAVE",font="Corbel 9 bold", fg = "White", bg = "#474954", width=25,height=2, command=SaveTodos)
